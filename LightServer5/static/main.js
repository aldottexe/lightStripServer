...
sub.style.backgroundColor = mids[rand]
...
let lights = []
for(let i = 1; i <= 5; i++){
    lights.push(document.querySelector('#L'+(i)))
}
console.log(lights)

box1.addEventListener('input', updateLight)

box2.addEventListener('input', updateLight)